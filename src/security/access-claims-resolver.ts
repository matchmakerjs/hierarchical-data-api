...
export const getAccessTokenFromCookie = (req: IncomingMessage) =>
  getCookieValue(req, process.env.ACCESS_TOKEN_COOKIE_NAME || "access_token");

export class BearerTokenAccessClaimsResolverWithCookieSupport
  implements AccessClaimsResolver<IncomingMessage>
{
